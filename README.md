...
OnCall Notify is your unified on-call status monitor for macOS. Currently supporting **PagerDuty** and **FireHydrant** with
...
- ✅ **FireHydrant** - Support for incidents (on-call schedules in development)
